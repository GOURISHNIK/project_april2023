...
public class Action extends BaseClass {
	...
	// use javascript click when normal click is not working
	public static boolean javaScriptClick(WebDriver driver, WebElement ele) {
		boolean flag = false;
		try {
	...
	// JavaScript to scroll to the givenElement
	public static  void javaScriptScrollByVisibilityOfElement(WebDriver driver, WebElement ele) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView();", ele);

	}

	// JavaScript to scroll in webPage to required offsets / horizontal / vertical scroll
	public static  void javaScriptScrollByVisibilityOfElement(WebDriver driver) {
